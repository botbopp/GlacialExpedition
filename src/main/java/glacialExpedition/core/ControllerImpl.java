...
public class ControllerImpl implements Controller {
    ...
    public String retireExplorer(String explorerName) {
        ...
        return String.format(EXPLORER_RETIRED, explorerToRemove);
    }
    ...
    public String exploreState(String stateName) {
        ...
        long countOfRetiredExplorers = explorers.stream().filter(explorer -> explorer.getEnergy() == 0).count();
        exploredStates++;

        return String.format(STATE_EXPLORER, stateName, countOfRetiredExplorers);
    }
